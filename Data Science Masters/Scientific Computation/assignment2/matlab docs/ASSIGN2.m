...
%[result,iterations_performed,flag] = FixedIterfunc(N,g2,3,1) %does not work as expected 
%-> does not hit stopping criteria -> does not converge

[result,iterations_performed,flag] = FixedIterfunc(N,g3,4,10e-6) 
...
%works - 16 iterations for N = 100 and N = 1000
...
%%
%Implementation of Damped Newton-Raphson Method for our problem:
%-u(x)'' + f(x,u) = 0, u(0) = u(1) = 0
...
%[result,iterations_performed,flag] = DampedNewtonfunc(N,g1,g1_u,20,10e-6) %works - 4 iterations for N = 100/1000

%[result,iterations_performed,flag] = DampedNewtonfunc(N,g2,g2_u,20,10e-6)
%works - 6 iterations for N = 100 and N = 1000

[result,iterations_performed,flag] = DampedNewtonfunc(N,g3,g3_u,20,10e-6)
%works - 7 iterations for N = 100 and N = 1000
